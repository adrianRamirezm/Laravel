    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="nav nav-pills">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ setActive('contacto') }}" href="{{route('contacto')}}">@lang('Contacto')</a></li>
                <li class="nav-item">
                    <a class="nav-link {{ setActive('projects') }}" href="{{route('projects.index')}}">@lang('Portafolio')</a></li>
                @guest
                <li class="nav-item">
                    <a class="nav-link {{ setActive('login') }}" href="{{route('login')}}">@lang('Login')</a></li>
                @else
                <li class="nav-item">
                    <a class="nav-link {{ setActive('Cerrar sesion') }}" href="#" onclick="event.preventDefault();
